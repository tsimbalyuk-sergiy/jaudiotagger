...
public class AiffFileHeader
{
    ...
    private static Logger logger = LoggerFactory.getLogger("org.jaudiotagger.audio.aiff.AudioFileHeader");
    ...
    public long readHeader(FileChannel fc, final AiffAudioHeader aiffAudioHeader) throws IOException, CannotReadException
    {
        ...
        if(FORM.equals(signature))
        {
            ...
            logger.trace(loggingName + ":Reading AIFF header size:" + Hex.asDecAndHex(chunkSize)
